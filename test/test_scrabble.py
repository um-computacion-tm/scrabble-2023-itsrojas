...
'''   def test_game_over_two_consecutive_passes(self):
        scrabble_game = ScrabbleGame(players_count=2)
        scrabble_game.players[0].active = False  # Simular el primer paso del jugador 1
        scrabble_game.skip_turn()  # Simular el primer paso del jugador 2

        self.assertTrue(scrabble_game.two_consecutive_passes())
        self.assertTrue(scrabble_game.is_game_over())'''
...
'''class TestScrabbleGame(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.game.next_turn()
        self.game.players[self.game.current_player].draw_initial_tiles(self.game.bag_tiles)
        self.game.players[self.game.current_player].board = self.game.board
